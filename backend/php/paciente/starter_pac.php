  ...
  <div class="wrapper">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-body">
                  <div class="row">
                    ...
                    <div class="col-xs-4 text-center">
                      <a href="./logout_pac.php" class="btn btn-default">Deslogar</a>
                    </div>
                  </div>
                  <!-- /.row -->
                </li>
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="active"><a href="starter_pac.php"><i class="fa fa-laptop"></i> <span>Início</span></a></li>
          <li><a href="exibir_consultas_pac.php"><i class="fa fa-map-pin"></i> <span>Ver consultas</span></a></li>
          <li><a href="exibir_exames_pac.php"><i class="fa fa-map-pin"></i> <span>Ver exames</span></a></li>
        </ul>
        <!-- /.sidebar-menu -->
      </section>
      <!-- /.sidebar -->
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <p style="font-size: 22px"><b>Seja bem vindo</b>
        </p>
      </section>
