      ...
      <div class="input-field col s12">
        ...
        <div id="login-page" class="row">
          <div class="col s12 z-depth-2 card-panel">
            <form class="login-form" action="../../php/planos/funcao.php" method="post" onsubmit="return formLab(this)">
              <div class="row">
                <div class="input-field col s12">
              ...
              <div class="row">
                <div class="input-field col s12">
                  ...
                  <input class="validate" id="CNPJ" type="number" name="CNPJ" required />
              ...
              <div class="row">
                <div class="input-field col s12">
                  ...
                  <input class="validate" id="exametipos" type="text" name="exametipos" required />
