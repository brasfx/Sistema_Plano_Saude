...
include "../../planoshg/consultas.php";
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="exibir_consultas_pac.php"><i class="fa fa-map-pin"></i> <span>Ver consultas</span></a></li>
    ...
    <section class="content container-fluid">
      ...
      <div class="box">
          <div class="box-header">
              <h3 class="box-title">Minhas Consultas</h3>
