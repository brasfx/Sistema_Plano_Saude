  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="starter_med.php"><i class="fa fa-laptop"></i> <span>Início</span></a></li>
        ...
        <div class="box box-primary">
            ...
            <form role="form" action="../../planoshg/funcao.php" method="post">
                <div class="box-body">
                    ...
                    <!-- <div class="form-group">
                        <label for="laboratorio">Médico</label>
                        <input type="text" class="form-control" id="CRM" name="CRM" value="1 2 3 4 5">
                    </div> -->
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="tipoExame">Receita</label>
                        <textarea class="form-control" rows="3" id="receita" name="receita" placeholder="Receita" required></textarea>
                    </div>
                    <div class="form-group">
                        <label>Observações</label>
                        <textarea class="form-control" rows="3" id="observacoes" name="observacoes" placeholder="Observações" required></textarea>
                    </div>
                </div>
                <!-- /.box-body -->
